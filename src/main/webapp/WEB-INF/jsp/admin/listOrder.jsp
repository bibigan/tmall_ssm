            ...
            <tbody>
            	<c:forEach items="${os}" var="o">
            		<tr>
            			<td>${o.id}</td>
            			<td>${o.statusDesc}</td>
            			<td>￥<fmt:formatNumber value="${o.total}" type="number" minFractionDigits="2"/></td>
...
<!-- 	                               			跳转到前台产品界面 -->
	                               			<td> <a href="foreproduct?pid=${oi.product.id}">
	                               				${oi.product.name}
	                               			</a></td>
	                               			<td align="right">
	                               				<span class="text-muted">${oi.number}个
	                               			</td>
	                               			<td align="right">
